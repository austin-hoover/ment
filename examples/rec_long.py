...
This script uses a PyORBIT lattice model consisting of a harmonic RF cavity surrounded
by two drifts. Things are a bit slow because we have to repeatedly convert between NumPy
arrays and Bunch objects, but it works.
